...
const INSTRUCTIONS: Record<string, InstructionSignature> = {
    'CAddMatrix': {name:'CAddMatrix', params:['tag', 'rq', 'matrix', 'path', 'fmt', 'sparse', 'file_sparse']},
    'CNewMatrix': {name:'CNewMatrix', params:['tag', 'rq', 'matrix', 'shape', 'fmt']},
    'SLoadTile': {name:'SLoadTile', params:['tag', 'rq', 'matrix', 'tile']},
    'CLoadTile': {name:'CLoadTile', params:['tag', 'rq', 'matrix', 'tile']},
    'SSaveTile': {name:'SSaveTile', params:['tag', 'rq', 'matrix', 'tile']},
    'SDropTile': {name:'SDropTile', params:['tag', 'rq', 'matrix', 'tile']},
    'CCvtTileD': {name:'CCvtTileD', params:['tag', 'rq', 'from', 'from_tile', 'to', 'to_tile']},
    'CTrfTileD': {name:'CTrfTileD', params:['tag', 'rq', 'from', 'from_tile', 'to', 'to_tile']},
    'PInpdTile': {name:'PInpdTile', params:['tag', 'rq', 'A', 'Atile', 'B', 'Btile', 'pe_rows']},
    'MInpdTile': {name:'MInpdTile', params:['tag', 'rq', 'from_tag', 'C', 'Ctile', 'mts']},
    'PTripTile': {name:'PTripTile', params:['tag', 'rq', 'A', 'Atile', 'B', 'Btile', 'pe_rows']},
    'MTripTile': {name:'MTripTile', params:['tag', 'rq', 'from_tag', 'C', 'Ctile', 'mts']},
    'PTrgtTile': {name:'PTrgtTile', params:['tag', 'rq', 'A', 'Atile', 'B', 'Btile', 'pe_rows']},
    'MTrgtTile': {name:'MTrgtTile', params:['tag', 'rq', 'from_tag', 'C', 'Ctile', 'mts']},
    'PTrgsTile': {name:'PTrgsTile', params:['tag', 'rq', 'A', 'Atile', 'B', 'Btile', 'pe_rows']},
    'MTrgsTile': {name:'MTrgsTile', params:['tag', 'rq', 'from_tag', 'C', 'Ctile', 'mts']},
    'GApplyRow': {name:'GApplyRow', params:['tag', 'rq', 'op', 'A', 'Atile', 'B', 'Btile', 'C', 'Ctile', 'gpe_rows']},
    'GElemTile': {name:'GElemTile', params:['tag', 'rq', 'op', 'from', 'from_tile', 'to', 'to_tile', 'gpe_rows']},
    'XExit': {name:'XExit', params:['rq']},
    'XPrint': {name:'XPrint', params:['rq', 'text']},
    'XPrintTile': {name:'XPrintTile', params:['rq', 'matrix', 'tile', 'sparse']},
    // 添加更多指令...
